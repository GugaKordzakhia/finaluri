...
public class HelloApplication extends Application {
    ...
    public ObservableList<PieChart.Data> getObservableList() {
        ...
        observableList.addAll(
                new PieChart.Data("New York", 20),
                new PieChart.Data("Barcelona", 44),
                new PieChart.Data("Berlin", 9),
                new PieChart.Data("Tbilisi", 26),
                new PieChart.Data("Tallinn", 3),
                new PieChart.Data("Paris", 35));
